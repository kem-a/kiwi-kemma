...
function createUserGtkConfig() {
    try {
        ...
        processUserGtkFile(gtk3UserPath, gtk3ImportLine);
        
        // Process GTK 4 config
        processUserGtkFile(gtk4UserPath, gtk4ImportLine);
...
function processUserGtkFile(filePath, importLine) {
    try {
